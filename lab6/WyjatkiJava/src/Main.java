...
public class Main {
    public static void main(String[] args) {
        Customer customer1 = new Customer("Josh", "Nice", "3878527503", "USA, Miami, Canadian Street 34");
        Customer customer2 = new Customer("Kate", "MCkenzie", "58741265895", "Poland, Warszawa, ul. Poznanska 290");
        ...
        try{
            ...
            e.printStackTrace();
            e.fillInStackTrace(); // metoda fillInStackTrace() zastepuje oryginalny slad stosu tym, z miejsca, w ktorym zostal wywolany, w konsekwencji za drugim wywolaniem printStackTrace() (i oczywiscie fillInStackTrace()) widzimy troche mniej informacji
            e.printStackTrace();
        ...
        System.out.println();
        System.out.println("Searching for all Josh Nice's accounts...");
        try{
