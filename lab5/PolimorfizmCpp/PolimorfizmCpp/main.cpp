...
int main()
{
    ...
    cout << "\n---STUDENT----------------------------" << endl;
     ...
     cout << "static_cast/dynamic_cast..." << endl;
    ...
    while (currentCommand != "wyjscie")
    {
     ...
     //dynamic_cast!=nullptr,gdyz  dynamic_cast w wyniku zlego rzutowania zwroci nullptr
    ...
    //program
    //wpisujac odpowiednio student lub pracownik tworzony jest odpowiedni obiekt. Wywolywane sa odpowiednie konstruktory z klasy osoba, pozniej z wybranej
    //obiekt towrzony jest w oparciu o metode zdefiniowana w odpowiedniej klasie: FabrykaStudentow, FabrykaPracownikow
    //przez to ze klasa FabrykaOsob jest abstrakcyjna klasa wszystko dziala poprawnie. Kompilator dopasowauje odpowiednia redefinicje klasy.
    //Gdy bedziemy tworzyc studenta, uruchomi funkcje utworzy zdefiniowana w klasie FabrykaStudentow, tak samo z pracownikami.
    //bez slowka virtual nadpisywanie funkcjonalnosci metod z klasy rodzic nie byloby mozliwe.
}